...
merge: main.o iohandler.o article.o block.o hashfilefactory.o btree.o
	$(CC) -o $(NAME) iohandler.o main.o article.o block.o hashfilefactory.o btree.o $(CFLAGS)

main.o: hashfilefactory.o btree.o $(SRC_PATH)/main.cpp
